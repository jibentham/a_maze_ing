...
class AStarSolver(MazeSolver):
    def solve(self, grid):
        ...
        f_score = {grid.entrance: self._heuristic(grid.entrance, grid)}  # g + estimated cost to goal
        counter = count()
